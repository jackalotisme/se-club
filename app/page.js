              ...
              <div className="flex flex-col items-center space-y-4 text-center">
                <div className="space-y-2">
                  ...
                  <p className="mx-auto max-w-[700px] text-white md:text-xl dark:text-gray-400">
                    Improving the educational experience for programming
                    students here at Florida SouthWestern State College. We
                    review coding fundamentals, engage in workforce interview
                    preparation, and promote the practice of constructive
                    collaboration.
                  </p>
                </div>
              ...
              <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Vice President, SE Club</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <p>
                      "There's no better feeling than being part of a community
                      that supports and encourages you to grow."
                    </p>
                  </CardContent>
                </Card>
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Member, SE Club</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <p>
                      "Has been a great experience! The club has helped me grow
                      as a developer and connect with like-minded individuals."
                    </p>
                  </CardContent>
                </Card>
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Secretary, SE Club</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <p>
                      "I have learned so much from the club and have made some
